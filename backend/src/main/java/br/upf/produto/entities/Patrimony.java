...
public class Patrimony implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "tb_patrimony_category", 
	...
	public Patrimony(String name, Boolean status, String description, String code, String imgUrl, Double price,
			Departament departament, Set<Category> categories, Audit audit) {
		super();
		this.name = name;
		this.status = status;
